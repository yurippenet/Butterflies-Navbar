...
class mod_butterfliesnavbar{
	
	public static function getHTML($params){
		return str_repeat("<br class=\"hideonsmall\" />", intval($params->get("topspacing"))).$params->get('customhtml');
	}
	/**
	...
	public static function getList(&$params){
		...
		$cache = JFactory::getCache('mod_butterfliesnavbar', '');
